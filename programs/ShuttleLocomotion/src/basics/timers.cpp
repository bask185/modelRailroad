...
volatile unsigned char sens1T;
volatile unsigned char sens2T;
volatile unsigned char sens3T;
volatile unsigned char sens4T;
volatile unsigned char greenLedT;
volatile unsigned char redLedT;
volatile unsigned char speedKnobT;
